...
<body>
    <form method="post" action="form_prcess.php" name="frmQRGenerator" id="frm-qr"
        ...
        <div class="form-row">
         ...
         <div class="form-row">
              Middle Initial: <input type="text" name="middle_initial"
                id="middle_initial" class="input-field" />
         </div>
         <div class="form-row">
        ...
        <div class="form-row">
            Phone Number: <input type="number" name="phone_number"
                id="phone_number" class="input-field" />
        </div>

         <div class="form-row">
            Prc Number: <input type="number" name="prc_number"
                id="prc_number" class="input-field" />
         </div>

         <div class="form-row">
            Dental Chapter: <input type="text" name="dental_chapter"
                id="dental_chapter" class="input-field" />
         </div>
